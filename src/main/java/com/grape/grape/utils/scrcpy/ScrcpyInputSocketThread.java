...
import com.grape.grape.utils.common.PortTool;
...
/**
 * scrcpy socket线程（来自 screen-tools）
...
public class ScrcpyInputSocketThread extends Thread {
    ...
    public void run() {
        ...
        try {
            ...
            log.info("开始读取视频流，scrcpyLocalThread.isAlive()={}", scrcpyLocalThread.isAlive());
